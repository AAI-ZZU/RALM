...
def get_options(args=None):
    ...
    # my settings
    parser.add_argument('--aug_num', default=4, help='The number of data spins')
    parser.add_argument('--alpha', default=0.1, help='The number of data spins')

    # Data
    parser.add_argument('--problem', default='hcvrp', help="The problem to solve, default 'tsp'")
    ...
    parser.add_argument('--lr_critic', type=float, default=8e-5, help="Set the learning rate for the critic network")
    parser.add_argument('--lr_decay', type=float, default=0.999, help='Learning rate decay per epoch')
    ...
    # 二次微调需要加载第一次训练的模型
    # parser.add_argument('--load_path', default="outputs/hcvrp_v3_40_rollout_with_loss/epoch-40.pt", help='Path to load model parameters and optimizer state from')
    # 第一次寻来你无需加载模型
